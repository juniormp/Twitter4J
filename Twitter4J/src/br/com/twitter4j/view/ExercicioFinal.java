...
public class ExercicioFinal {
	...
	public static void main(String[] args) {
		...
		ts.organizarTweetsOrdernadosPorNomeERetornaApenasOPrimeiroEOUltimo(tweets).forEach(tweet -> System.out.println(tweet.getUser().getName()));
		System.out.println();
		
		System.out.println("==> 5. Ordenar os tweets por data, e exibir a data mais recente e a menos recente.");
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		ts.organizarTweetsOrdernadosPorDataERetornaApenasOPrimeiroEOUltimo(tweets).forEach(tweet -> System.out.println(sdf.format(tweet.getCreatedAt())));
		System.out.println();
